  ...
  describe('live source comparison', () => {
    ...
    it('runs full source parity check and generates report', async () => {
      ...
      for (const category of [
        ...
        'save-ai-attack-aim-state-fields',
        'save-ai-attack-fire-state-fields',
        'save-ai-internal-move-to-state-fields',
        'save-ai-attack-approach-state-fields',
        'save-attack-state-machine-fields',
        'save-ai-attack-state-fields',
        ...
        'save-object-weapon-status-helper-fields',
        'save-object-defection-helper-fields',
        'save-status-damage-helper-fields',
        'save-subdual-damage-helper-fields',
        'save-temp-weapon-bonus-helper-fields',
        'save-body-module-fields',
        'save-active-body-fields',
        'save-highlander-body-fields',
        'save-immortal-body-fields',
        'save-inactive-body-fields',
        'save-structure-body-fields',
        'save-hive-structure-body-fields',
        'save-undead-body-fields',
        'save-collide-module-fields',
        'save-squish-collide-fields',
        'save-fire-weapon-collide-fields',
        'save-crate-collide-fields',
        'save-convert-to-car-bomb-crate-collide-fields',
        'save-convert-to-hijacked-vehicle-crate-collide-fields',
        'save-heal-crate-collide-fields',
        'save-money-crate-collide-fields',
        'save-sabotage-command-center-crate-collide-fields',
        'save-sabotage-fake-building-crate-collide-fields',
        'save-sabotage-internet-center-crate-collide-fields',
        'save-sabotage-military-factory-crate-collide-fields',
        'save-sabotage-power-plant-crate-collide-fields',
        'save-sabotage-superweapon-crate-collide-fields',
        'save-sabotage-supply-center-crate-collide-fields',
        'save-sabotage-supply-dropzone-crate-collide-fields',
        'save-salvage-crate-collide-fields',
        'save-shroud-crate-collide-fields',
        'save-unit-crate-collide-fields',
        'save-veterancy-crate-collide-fields',
        'save-die-module-fields',
        'save-create-crate-die-fields',
        'save-create-object-die-fields',
        'save-crush-die-fields',
        'save-dam-die-fields',
        'save-destroy-die-fields',
        'save-eject-pilot-die-fields',
        'save-fx-list-die-fields',
        'save-keep-object-die-fields',
        'save-rebuild-hole-expose-die-fields',
        'save-special-power-completion-die-fields',
        'save-upgrade-die-fields',
        ...
        'save-preorder-create-fields',
        'save-special-power-create-fields',
        'save-supply-center-create-fields',
        'save-supply-warehouse-create-fields',
        'save-veterancy-gain-create-fields',
        'save-upgrade-module-object-fields',
        'save-active-shroud-upgrade-fields',
        'save-delayed-upgrade-fields',
        'save-armor-upgrade-fields',
        'save-command-set-upgrade-fields',
        'save-cost-modifier-upgrade-fields',
        'save-experience-scalar-upgrade-fields',
        'save-grant-science-upgrade-fields',
        'save-locomotor-set-upgrade-fields',
        'save-max-health-upgrade-fields',
        'save-model-condition-upgrade-fields',
        'save-object-creation-upgrade-fields',
        'save-passengers-fire-upgrade-fields',
        'save-power-plant-upgrade-fields',
        'save-radar-upgrade-fields',
        'save-replace-object-upgrade-fields',
        'save-status-bits-upgrade-fields',
        'save-stealth-upgrade-fields',
        'save-sub-objects-upgrade-fields',
        'save-unpause-special-power-upgrade-fields',
        'save-weapon-bonus-upgrade-fields',
        'save-weapon-set-upgrade-fields',
        'save-special-power-module-object-fields',
        'save-baikonur-launch-power-fields',
        'save-cash-bounty-power-fields',
        'save-cash-hack-special-power-fields',
        'save-cleanup-area-power-fields',
        'save-defector-special-power-fields',
        'save-demoralize-special-power-fields',
        'save-fire-weapon-power-fields',
        'save-ocl-special-power-fields',
        'save-special-ability-power-fields',
        'save-spy-vision-special-power-fields',
        ...
        'save-delayed-weapon-set-upgrade-update-fields',
        ...
        'save-turret-state-machine-fields',
        'save-turret-ai-fields',
