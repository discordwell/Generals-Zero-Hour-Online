...
export function xferMapEntity(xfer: Xfer, e: Record<string, unknown>): void {
  ...
  if (version >= 17) {
    e.repulsorHelperUntilFrame = xfer.xferInt((e.repulsorHelperUntilFrame as number | undefined) ?? 0);
  } else {
    e.repulsorHelperUntilFrame = 0;
  }
  if (version >= 18) {
    e.statusDamageStatusName = xferNullableString(xfer, (e.statusDamageStatusName as string | null | undefined) ?? null);
    e.statusDamageClearFrame = xfer.xferInt((e.statusDamageClearFrame as number | undefined) ?? 0);
  } else {
    e.statusDamageStatusName = null;
    e.statusDamageClearFrame = 0;
  }
  ...
  if (version >= 54) {
    e.pendingExitState = xferNullableJsonObject(
      xfer,
      (e.pendingExitState as object | null | undefined) ?? null,
    );
  } else {
  ...
  if (version >= 56) {
    e.sourceAIFaceState = xferNullableJsonObject(
      xfer,
      (e.sourceAIFaceState as object | null | undefined) ?? null,
    );
  } else {
  ...
  if (version >= 20) {
    e.autoHealSoonestHealFrame = xfer.xferInt(e.autoHealSoonestHealFrame as number);
  } else {
    e.autoHealSoonestHealFrame = 0;
  }
  if (version >= 20) {
    e.autoHealStopped = xfer.xferBool(e.autoHealStopped as boolean);
  } else {
  ...
  if (version >= 32) {
    e.poisonDeathType = xfer.xferAsciiString((e.poisonDeathType as string | undefined) ?? 'POISONED');
  } else {
    e.poisonDeathType = 'POISONED';
  }
  ...
  if (version >= 30) {
    e.heightDieHasDied = xfer.xferBool(e.heightDieHasDied as boolean);
    e.heightDieLastPositionX = xfer.xferReal(e.heightDieLastPositionX as number);
    e.heightDieLastPositionZ = xfer.xferReal(e.heightDieLastPositionZ as number);
  } else {
    e.heightDieHasDied = false;
    e.heightDieLastPositionX = 0;
    e.heightDieLastPositionZ = 0;
  }
  ...
  if (version >= 28) {
    e.hordeHasFlag = xfer.xferBool((e.hordeHasFlag as boolean | undefined) ?? false);
  } else {
    e.hordeHasFlag = false;
  }
  ...
  if (version >= 43) {
    e.sourceMissileAIUpdateState = xferNullableJsonObject(
      xfer,
      (e.sourceMissileAIUpdateState as object | null | undefined) ?? null,
    );
  } else {
    e.sourceMissileAIUpdateState = null;
  }
  if (version >= 44) {
    e.sourceDeliverPayloadAIUpdateState = xferNullableJsonObject(
      xfer,
      (e.sourceDeliverPayloadAIUpdateState as object | null | undefined) ?? null,
    );
  } else {
    e.sourceDeliverPayloadAIUpdateState = null;
  }
  if (version >= 45) {
    e.sourceDumbProjectileBehaviorState = xferNullableJsonObject(
      xfer,
      (e.sourceDumbProjectileBehaviorState as object | null | undefined) ?? null,
    );
  } else {
    e.sourceDumbProjectileBehaviorState = null;
  }
  if (version >= 46) {
    e.sourceRailroadBehaviorState = xferNullableJsonObject(
      xfer,
      (e.sourceRailroadBehaviorState as object | null | undefined) ?? null,
    );
  } else {
  ...
  if (version >= 2) {
    ...
    if (version >= 14) {
      e.healthBoxOffset = xfer.xferCoord3D(
        (e.healthBoxOffset as { x: number; y: number; z: number } | undefined) ?? { x: 0, y: 0, z: 0 },
      );
    } else {
